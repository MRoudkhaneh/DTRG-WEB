...
export const PreviousStudy1 = memo(({ control, setValue }: IPatientField) => {
  return (
    <Select
    ...
    >
      ...
      <SelectOption value="Additional Signals">Additional Signals</SelectOption>
      <SelectOption value="Optimapp">Optimapp</SelectOption>
      <SelectOption value="Biocap Feasibility">Biocap Feasibility</SelectOption>
